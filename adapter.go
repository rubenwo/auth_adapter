...
//go:generate $REPO_ROOT/bin/mixer_codegen.sh -a mixer/adapter/auth_adapter_t/config/config.proto -x "-s=false -n auth_adapter_t -t authorization"

package auth_adapter_t
